...
\item We show that the observed boundary is consistent with explicit KV-cache pressure proxies, and that KV-aware features can complement coarse context cues for positive-regime detection near the regime boundary.
\end{itemize}
