...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run a dense GPU context sweep for a representative model.")
    parser.add_argument("--model", required=True)
    parser.add_argument("--quantization", choices=("none", "4bit", "8bit"), default="4bit")
    parser.add_argument("--contexts", default="128,256,384,512,640,768,1024")
    parser.add_argument("--batch-size", type=int, default=1)
    parser.add_argument("--max-new-tokens", type=int, default=16)
    parser.add_argument("--env", default="jongyun_2026")
    parser.add_argument("--tag", default="densectx")
